(function () {
      ...
      return function () {
        ...
        for (j = 0, len = ref.length; j < len; j++) {
          ...
          if (!matched && responsive.active) {
            ...
            results.push(
              typeof responsive.exit === "function" ? responsive.exit() : void 0
            );
          } else {
            results.push(void 0);
          }
  ...
  root.utils.bindJSControllers = function ($scope, force) {
    var bindJSFactory, ex, ref, tagname;
    if (force == null) {
      force = false;
    }
    ...
    try {
      tagname =
        ((ref = this.$scope.get(0)) != null ? ref.tagName : void 0) != null ||
        "";
      console.log(
        "Binding JS controllers/components for\n" +
          tagname +
          ":" +
          this.$scope.get(0).className +
          ". Force: " +
          force
      );
    } catch (error) {
    ...
    bindJSFactory = function (attrName, objectName, $scope) {
      ...
      return $scope.find(selector).each(
        (function (_this) {
  ...
  root.responsiveImages = function () {
    ...
    return $("[data-responsive-image-dimensions]").each(function () {
      var dimPairs, dims, ex, height, width;
